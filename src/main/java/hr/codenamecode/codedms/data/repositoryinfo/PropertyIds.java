...
public final class PropertyIds {
    ...
    /**
     * CMIS property {@code cmis:objectTypeId}: ID of primary type of the object.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
     *
    ...
    /**
     * CMIS property {@code cmis:secondaryObjectTypeIds} (multivalue): list of IDs of the secondary
     * types of the object.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
    ...
    // ---- document ----
    /**
     * CMIS document property {@code cmis:isImmutable}: flag the indicates if the document is
     * immutable.
     *
     * <p>CMIS data type: boolean<br>
     * Java type: Boolean
     *
     * @cmis 1.0
     */
    ...
    /**
     * CMIS document property {@code cmis:isLatestVersion}: flag the indicates if the document is the
     * latest version.
     *
     * <p>CMIS data type: boolean<br>
     * Java type: Boolean
    ...
    /**
     * CMIS document property {@code cmis:isMajorVersion}: flag the indicates if the document is a
     * major version.
     *
     * <p>CMIS data type: boolean<br>
     * Java type: Boolean
    ...
    /**
     * CMIS document property {@code cmis:isLatestMajorVersion}: flag the indicates if the document is
    ...
    /**
     * CMIS document property {@code cmis:versionLabel}: version label of the document.
     *
     * <p>CMIS data type: string<br>
     * Java type: String
     *
    ...
    /**
     * CMIS document property {@code cmis:versionSeriesId}: ID of the version series.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
     *
    ...
    /**
     * CMIS document property {@code cmis:isVersionSeriesCheckedOut}: flag the indicates if the
    ...
    /**
     * CMIS document property {@code cmis:versionSeriesCheckedOutBy}: user who checked out the
     * document, if the document is checked out.
     *
     * <p>CMIS data type: string<br>
     * Java type: String
     *
    ...
    /**
     * CMIS document property {@code cmis:versionSeriesCheckedOutId}: ID of the PWC, if the document
     * is checked out.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
    ...
    /**
     * CMIS document property {@code cmis:checkinComment}: check-in comment for the document version.
     *
     * <p>CMIS data type: string<br>
     * Java type: String
     *
    ...
    /**
     * CMIS document property {@code cmis:contentStreamLength}: length of the content stream, if the
     * document has content.
     *
     * <p>CMIS data type: integer<br>
    ...
    /**
     * CMIS document property {@code cmis:contentStreamMimeType}: MIME type of the content stream, if
    ...
    /**
     * CMIS document property {@code cmis:contentStreamFileName}: file name, if the document has
     * content.
     *
     * <p>CMIS data type: string<br>
     * Java type: String
    ...
    /**
     * CMIS document property {@code cmis:isPrivateWorkingCopy}: flag the indicates if the document is
     * a PWC.
     *
     * <p>CMIS data type: boolean<br>
     * Java type: Boolean
    ...
    /**
     * CMIS folder property {@code cmis:allowedChildObjectTypeIds} (multivalue): IDs of the types that
     * can be filed in the folder.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
     *
    ...
    // ---- relationship ----
    /**
     * CMIS relationship property {@code cmis:sourceId}: ID of the source object.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
     *
    ...
    /**
     * CMIS relationship property {@code cmis:targetId}: ID of the target object.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
     *
    ...
    /**
     * CMIS retention property {@code cmis:rm_destructionDate}: destruction date.
     *
     * <p>CMIS data type: datetime<br>
     * Java type: GregorianCalendar
     *
    ...
    /**
     * CMIS retention property {@code cmis:rm_holdIds} (multivalue): IDs of the holds that are
     * applied.
     *
     * <p>CMIS data type: id<br>
     * Java type: String
    ...
    // ---- extensions ----
    /**
     * Content Hash property {@code cmis:contentStreamHash} (multivalue): hashes of the content stream
     *
     * <p>CMIS data type: string<br>
     * Java type: String
     *
    ...
    /**
     * Latest accessible state property {@code cmis:latestAccessibleStateId}: ID of the latest
